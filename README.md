...
# JANGGO-SYSTEM COMPANY

## # 프로젝트 설명

* 이 프로젝트는 JANGGO COMPANY site 개발을 위한 프로젝트입니다.
...
* 2019-02-03
  * board app 추가 (90%)
  * apply app 추가 (60%)
    * apply 내용 수정하기 (파일 재업로드) 완료
    * delete 미구현
* 2019-02-08
  * mainsite footer 수정 (완료)
  * custom.css 추가 (완료)
* 2019-02-13
  * product app 추가 (0%)
...
* gorilla-Kim
  * product app views.py 작업
* jangheeseung
  * product app front-end 작업
* 남
* YoungBeans
  * board 대댓글 작업
